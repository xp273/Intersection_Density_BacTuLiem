<?php
    ...
    $result = $pdo->query(' SELECT "fid", "osm_id", "osm_id_2", ST_AsGeoJson(geom, 5) AS geojson FROM "intersections_wgs4326_wgs84" ');
    $features=[];
    ...
    //File output
    //file_put_contents('latest_results_intersections.json', json_encode($featureCollection,  JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES));
